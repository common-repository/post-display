<?php
function tzpost_news_feature($tzpostID,$template, $plist,$query,$query_arg,$container,$content){
    ob_start(); ?>
    ...
    <?php } ?>
    <ul id="<?php echo "tzpost" . $tzpostID; ?>" class="tzpost-feature">
        <?php $count = 1;
        ...
        ?>
            ...
            <li class="tzpost_item_feature">
                ...
                <?php } ?>
            </li></div><div class="feature-right">
            <?php } else{ ?>

        <li class="tzpost_item_fr">
            <?php
            if ($content['tzpost_image_display'] == 'yes') {
                if (has_post_thumbnail()) { ?>
                    <a href="<?php the_permalink(); ?>">
